...
vec3 ColorMixing::AdditiveColorMixing(const vec3& Color1, const vec3& Color2)
{
    ...
    MixedColor.r = std::fmin(std::fmax(MixedColor.r, 0.0), 1.0);
    MixedColor.g = std::fmin(std::fmax(MixedColor.g, 0.0), 1.0);
    MixedColor.b = std::fmin(std::fmax(MixedColor.b, 0.0), 1.0);
